...
public class AllergyIntoleranceComparator extends AbstractPropertyComparator<AllergyIntolerance> {
	...
	@Override
	public List<Boolean> compareProps(AllergyIntolerance a1, AllergyIntolerance a2) {
		List<Boolean> result = new ArrayList<>();

		result.add(arePropsEquals(a1.getPatient(), a2.getPatient()));
		...
		result.add(arePropsEquals(a1.getCode(), a2.getCode()));
