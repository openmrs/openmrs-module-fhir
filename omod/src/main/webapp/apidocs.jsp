                    ...
                    <tr>
                        ...
                        <td>
                            <select id="languagelist">
                                ...
                                <option>aspNet5<option>
                                <option>asyncScala<option>
                                <option>spring<option>
                                <option>csharpDotNet2<option>
                                <option>haskell<option>
                                <option>ada<option>
                                <option>ada-server<option>
                                <option>akka-scala<option>
                                <option>apache2-config<option>
                                <option>apex<option>
                                <option>aspnet-server<option>
                                <option>bash<option>
                                <option>confluence-wiki<option>
                                <option>cpp-rest-client<option>
                                <option>charp-dot-net2<option>
                                <option>eiffel<option>
                                <option>elm<option>
                                <option>erlang<option>
                                <option>erlang-server<option>
                                <option>finch-server<option>
                                <option>flask-connexion<option>
                                <option>go-server<option>
                                <option>haskel-http<option>
                                <option>haskel-servant<option>
                                <option>java-cxf<option>
                                <option>java-cxf-server<option>
                                <option>java-inflector-server<option>
                                <option>java-jaxrs-cxfcdi-server<option>
                                <option>java-jaxrs-spec-server<option>
                                <option>java-jersey-server<option>
                                <option>java-msf4j-server<option>
                                <option>java-pkmst-server<option>
                                <option>java-play-framework<option>
                                <option>java-resteasy-eap-server<option>
                                <option>java-resteasy-server<option>
                                <option>java-vertx-server<option>
                                <option>javascript-closure-angular<option>
                                <option>kotlin<option>
                                <option>kotlin-server<option>
                                <option>lua<option>
                                <option>lumen-server<option>
                                <option>nancy-fx-server<option>
                                <option>nodejs-server<option>
                                <option>objc<option>
                                <option>pistache-server<option>
                                <option>powershell<option>
                                <option>qt5cpp<option>
                                <option>rclient<option>
                                <option>rails5-server<option>
                                <option>restbed<option>
                                <option>rust<option>
                                <option>rust-server<option>
                                <option>scala-gatling<option>
                                <option>scala-lagom-server<option>
                                <option>scala-tra-server<option>
                                <option>scalaz<option>
                                <option>silex-server<option>
                                <option>sinatra-server<option>
                                <option>slim-framework-server<option>
                                <option>staticdoc<option>
                                <option>static-html2<option>
                                <option>static-html<option>
                                <option>swagger<option>
                                <option>swagger-yaml<option>
                                <option>swift3<option>
                                <option>swift4<option>
                                <option>swift<option>
                                <option>symfony-server<option>
                                <option>tizen<option>
                                <option>typescript-angular<option>
                                <option>typescript-angular-js<option>
                                <option>typescript-aureliac<option>
                                <option>typescript-fetch<option>
                                <option>typescript-inversify<option>
                                <option>typescript-jquery<option>
                                <option>typescript-node<option>
                                <option>undertow<option>
                                <option>zend-expressive-path-handler<option>
                            </select>
                        </td>
                    </tr>
                    <tr height="20"></tr>
