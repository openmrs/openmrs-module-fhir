...
<openmrs:require anyPrivilege="View FHIR Client" otherwise="/login.htm" redirect="/module/fhir/test.form"/>

<h2><spring:message code="fhir.client.title"/></h2>
...
<table id="target">
	...
	<tr>
		<td>Body content</td>
		<td><input type="text" id="json" value='' size="45"/></td>
	</tr>
</table>
...
<script type="text/javascript">
	...
	function onSuccess(obj, msg, req) {
		jQuery("#output").html("Response" + "!<br/>");
		jQuery("#output").jsonViewer(obj);
