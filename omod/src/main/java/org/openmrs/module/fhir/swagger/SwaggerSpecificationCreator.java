		...
		for (CapabilityStatement.CapabilityStatementRestComponent restResource : resources) {
			for (CapabilityStatement.CapabilityStatementRestResourceComponent resource : restResource.getResource()) {
				...
				for (CapabilityStatement.ResourceInteractionComponent restResourceInteraction : restResourceInteractions) {
					...
					if (SwaggerDocConstants.READ.equalsIgnoreCase(restResourceInteraction.getCode().toCode())) {
						...
						readOperation.setSummary(SwaggerDocConstants.RETURNS + " " + resourceName + " "
								+ SwaggerDocConstants.DETAILS_OF_GIVEN_ID);
						List<String> produces = new ArrayList<String>();
						//Set mime type supported
						produces.add(SwaggerDocConstants.PRODUCES_JSON);
						produces.add(SwaggerDocConstants.PRODUCES_XML);
						...
						parameter.setDescription(SwaggerDocConstants.ID_DESCRIPTION + " " + resourceName + " "
						...
						responseSuccess.setDescription(SwaggerDocConstants.RETURNS + " " + resourceName + " "
								+ SwaggerDocConstants.DETAILS_OF_GIVEN_ID);
						...
						parameter.setDescription(
								resourceName + " " + SwaggerDocConstants.RESOURCE + " " + SwaggerDocConstants.OBJECT);
						...
						parameterId.setDescription(SwaggerDocConstants.ID_DESCRIPTION + " " + resourceName + " "
								+ SwaggerDocConstants.RESOURCE);
						...
						deleteOperation.setSummary(SwaggerDocConstants.RETURNS + " " + resourceName + " "
								+ SwaggerDocConstants.DETAILS_OF_GIVEN_ID);
						...
						Map<String, Response> responseMap = new HashMap<String, Response>();
						Response responseSuccess = new Response();
						responseSuccess.setDescription(SwaggerDocConstants.DELETE_DESCRIPTION + " " + resourceName + " "
								+ SwaggerDocConstants.DETAILS_OF_GIVEN_ID);
						Map<String, String> examplesSuccess = new HashMap<String, String>();
						examplesSuccess.put(SwaggerDocConstants.CONSUMES_JSON, SwaggerDocConstants.SUCCESS_PAYLOAD);
						responseSuccess.setExamples(examplesSuccess);
					...
					} else if (SwaggerDocConstants.SEARCH_TYPE
							.equalsIgnoreCase(restResourceInteraction.getCode().toCode())) {
						...
						searchOperation.setSummary(SwaggerDocConstants.RETURNS + " " + resourceName + " "
						...
						List<CapabilityStatement.CapabilityStatementRestResourceSearchParamComponent> searchParams = resource
								.getSearchParam();
						...
						Map<String, Response> responseMap = new HashMap<String, Response>();
						Response responseSuccess = new Response();
						responseSuccess.setDescription(SwaggerDocConstants.BUNDLE_DESCRIPTION + " " + resourceName + " "
								+ SwaggerDocConstants.RESOURCES);
						Schema schemaSuccess = new Schema();
						schemaSuccess.setRef(getSchemaRef(resourceName));
			...
			for (CapabilityStatement.CapabilityStatementRestOperationComponent restOperation : restResource.getOperation()) {
				if (SwaggerDocConstants.EVERYTHING.equalsIgnoreCase(restOperation.getName())) {
					...
					for (CapabilityStatement.CapabilityStatementRestResourceComponent restComponent : resources.get(0)
							.getResource()) {
						if (resourceNameRef.contains(restComponent.getType()) && !SwaggerDocConstants.OPERATION_DEFINITON
								.equals(restComponent.getType())) {
							resourceName = restComponent.getType();
						}
					}
					String pathId = "/" + resourceName + "/" + SwaggerDocConstants.POST_RESOURCE_PATH + "/"
							+ SwaggerDocConstants.EVERYTHING_WITH_DOLLAR_PREFIX;
					Path everything;
					...
					everythingOp.setSummary(SwaggerDocConstants.RETURNS + " " + resourceName + " "
							+ SwaggerDocConstants.EVERYTHING_OF_GIVEN_ID);
					List<String> produces = new ArrayList<String>();
					//Set mime type supported
					produces.add(SwaggerDocConstants.PRODUCES_JSON);
					produces.add(SwaggerDocConstants.PRODUCES_XML);
					...
					Parameter parameter = new Parameter();
					parameter.setDescription(
							SwaggerDocConstants.ID_DESCRIPTION + " " + resourceName + " " + SwaggerDocConstants.RESOURCE);
					parameter.setName(SwaggerDocConstants.ID);
					parameter.setIn(SwaggerDocConstants.IN_PATH);
					parameter.setRequired(true);
					parameters.add(parameter);
					...
					parameterBody.setDescription(
							resourceName + " " + SwaggerDocConstants.RESOURCE + " " + SwaggerDocConstants.BODY_SAMPLE_VALUE);
