 ...
 * <td>The resource ID associated with this request, or the resource name if the request applies to
 * a type but not an instance, or "" otherwise</td>
 * </tr>
 * <tr>
 * <td>${operationType}</td>
 * <td>A code indicating the operation type for this request, e.g. "read", "history-instance", etc.)
 * </td>
 * </tr>
 * <tr>
 * <td>${remoteAddr}</td>
 ...
 * "${requestHeader.x-forwarded-for} will yield the value of the first header named "
 * x-forwarded-for", or "" if none.</td>
 * </tr>
 * <tr>
 ...
 * </table>
 */
public class LogInterceptor extends InterceptorAdapter {
	
	private static final org.slf4j.Logger ourLog = org.slf4j.LoggerFactory.getLogger(LogInterceptor.class);
	...
	@Override
	public boolean incomingRequestPostProcessed(final RequestDetails theRequestDetails, final HttpServletRequest theRequest,
