...
import org.openmrs.module.fhir.api.*;
...
public class FHIRPatientResource extends DelegatingCrudResource {
	...
	public DelegatingResourceDescription getRepresentationDescription(Representation rep) {
		if (rep instanceof DefaultRepresentation) {
			...
			description.addProperty("resourceType", findMethod("getDisplayString"));
    ...
    public Patient getPatient(SimpleObject propertiesToCreate) {
        ...
        if (personProperty == null) {
            ...
            System.out.println("The uuid is : " + (String) personProperty);
	...
	public String getByUniqueId(String uuid, String contentType) {
        ...
        System.out.println(FHIRPatientUtil.generatePatient(patient,contentType));

        return FHIRPatientUtil.generatePatient(patient,contentType);
	}
